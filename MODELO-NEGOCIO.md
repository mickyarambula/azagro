...
2. **El spread cambiario cuando la compra es en dólares y la venta en pesos** (transversal (ii)). `fxSpread` exige que la orden de compra Y el pedido sean en dólares, así que en #9-12 sale 0 por construcción. Depende de **8.2-4**, que sigue abierta: quién absorbe el movimiento del dólar en una venta en pesos con costo en dólares.
...
4. **Lo que el dueño no ha decidido**: 8.2-4 y 8.2-5 (`ESTADO.md`), y si la mora de una factura en dólares debe poder cobrarse en dólares — el Excel dice que en su momento se hizo (`EXCEL_VS_SISTEMA.md` § 4), el sistema la cobra siempre en pesos sobre el cargo al tipo de cambio pactado.
