...
test("FV, FP, NC, FI, ATC y facturas de corte guardan quién las generó", () => {
  ...
  assert.ok(src("src/lib/erp/cutover-core.ts").includes("opening_paid, policy_code, created_by"), "facturas importadas con autor y con su política de cobro (el insert vive en cutover-core.ts)");
});
