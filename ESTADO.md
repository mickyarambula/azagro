...
**Pendiente (en orden):** paso 2 = selector (solo administrador, el sistema propone y la persona confirma, editable hasta confirmar el pedido, renombrar "Tipo de entrega: Circuito ASR" → "Entrega directa vía ASR"); paso 3 = el motor lee el circuito (base de financiamiento, comisión congelada en la cotización — § 6 —, "Comisión ASR" sale de Ajustes); paso 4 = reportes por circuito; paso 5 = encender la Línea Santa Rosa.
