...
**Fecha:** 15-sep-2026 · **Base:** `main` en `b8b6576`+ · **Alcance:** diagnóstico y plan; nada construido.
...
**Dependencias:** 1 → 2 → 3 y 4 → 5 → 6. Los pasos 1-3 no tocan la app. Todo aditivo; ninguna prueba existente cambia; `npm test` parte de 588.
